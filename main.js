...
process.env.CHROME_PATH = '/root/.cache/puppeteer/chrome/linux-128.0.6613.137/chrome-linux64/chrome';
...
if (process.argv.length < 7) {
    ...
    console.log(`
    ${'🚀 '.bold}${colors.magenta.bold('CDP v1.4')} | ${`${`Bypasses Cloudflare`.yellow.bold}, ${`HTTPDDOS`.yellow.bold}, ${`DDoS-Guard`.yellow.bold}, ${'Recaptcha'.yellow.bold}, ${'Stormwall'.yellow.bold} & ${'ReactJS'.yellow.bold}`.italic},
